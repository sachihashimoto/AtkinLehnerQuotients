...
// Errors on hyperelliptic N; use XZeroNstar for that case.
    ...
    repeat
        ...
        // For g >= 6 the canonical ideal is generated by quadrics unless the curve
        // is trigonal (or a plane quintic), in which case cubics are also needed
        // (Petri).  If quadrics alone do not cut out a curve, add the cubics.
